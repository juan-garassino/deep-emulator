...
# --- synthetic emulator: re-exported from the package ------------------------
# (promoted to deepEmulator/platforms/synthetic.py so tests + the vectorized
# runner can use it; re-exported here for back-compat with existing imports)
from deepEmulator.platforms.synthetic import (  # noqa: E402,F401
    SyntheticCartridge,
